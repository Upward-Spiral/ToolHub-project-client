...
import {
    getToolDetails, UploadToolImg, updateToolImage,
    updateTool, deleteTool, reserveTool
} from '../utils/toolQueries'
import { getCatL0List, getCatL1List, getCatL2List } from '../utils/service'
import {
    shareTool, unshareTool, borrowTool,
    unborrowTool, unreserveTool
} from '../utils/toolQueries'
import { Col, Button, Card, Form, Container, Row, Image } from 'react-bootstrap'
import toolsAvatar from '../assets/images/tools-avatar.png'
                                    ...
                                    <Card.Body>
                                        <Row>
                                            <Col className="flex-row-center">
                                                ...
                                                >
                                                    <Image src={leftArrow} roundedCircle className="image-navigation" alt="previous image" />
                                                </Button>
